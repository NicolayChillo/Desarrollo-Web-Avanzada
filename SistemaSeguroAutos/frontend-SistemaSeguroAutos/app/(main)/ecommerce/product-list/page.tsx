...
// usasr useEfect para cargar datos de la api
useEffect(()=>{
    const loadProducts = async() =>{
        //llamar a api publica dummyson
        const res= await fetch("http://dummyjson.com/products");
        const data = await res.json();

        //mostrar datos a la interface
                            ...
                            <div key={i} className="col-12 md:col-6 lg:col-4">
                                <div className="p-2">
                                    <div className="shadow-2 p-4 surface-card border-round">
                                        ...
                                        {/*dd*/}
                                        <p className="mt-0 mb-3 text-700 line-height-3">{product.descripcion}</p>
